...
class Application:
    ...
    def __init__(self):
        ...
        self.json_file = open("/home/alice/Desktop/Project/model/model1.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()

        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights("/home/alice/Desktop/Project/model/model1.h5")
        # 
        self.json_file_dru = open("model/model-bw_dru.json" , "r")#/home/alice/Desktop/Project/model/model-bw_dru.json
